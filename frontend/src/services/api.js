...
export const tracesApi = crud('traces');
export const promptsApi = crud('prompts');
export const evalsApi = crud('evals');
export const alertsApi = crud('alerts');
export const prompt_versionsApi = crud('prompt-versions');
export const eval_resultsApi = crud('eval-results');
export const api_keysApi = crud('api-keys');

export const aiRegressionDetect = (body) => request('/ai/regression-detect', { method: 'POST', body: JSON.stringify(body || {}) });
export const aiAutoRca = (body) => request('/ai/auto-rca', { method: 'POST', body: JSON.stringify(body || {}) });
export const aiDriftScore = (body) => request('/ai/drift-score', { method: 'POST', body: JSON.stringify(body || {}) });
export const aiAnomalyClassify = (body) => request('/ai/anomaly-classify', { method: 'POST', body: JSON.stringify(body || {}) });
export const aiPromptDiff = (body) => request('/ai/prompt-diff', { method: 'POST', body: JSON.stringify(body || {}) });
